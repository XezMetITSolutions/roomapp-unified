            ...
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-hotel-navy rounded-xl flex items-center justify-center">
                <svg width="24" height="24" viewBox="0 0 32 32" fill="none">
                  <path d="M25.5 9.5L19.5 16.5L25.5 23.5" stroke="#D4AF37" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M13.5 9.5L7.5 16.5L13.5 23.5" stroke="#D4AF37" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <div>
