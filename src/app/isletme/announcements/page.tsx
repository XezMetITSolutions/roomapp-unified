                      ...
                      <div className="space-y-3">
                        <div>
                          <label className="block text-sm font-medium text-gray-600 mb-1">
                            Başlık ({langNames[lang as keyof typeof langNames]})
                          </label>
                          <input
                            type="text"
                            name={`${lang}_title`}
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-hotel-gold focus:border-transparent"
                            placeholder={`${langNames[lang as keyof typeof langNames]} başlık`}
                          />
                        </div>
                        
                        <div>
                          <label className="block text-sm font-medium text-gray-600 mb-1">
                            İçerik ({langNames[lang as keyof typeof langNames]})
                          </label>
                          <textarea
                            name={`${lang}_content`}
                            ...
                            rows={3}
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-hotel-gold focus:border-transparent"
                            placeholder={`${langNames[lang as keyof typeof langNames]} içerik`}
                          />
                        </div>
                        
                        <div>
                          <label className="block text-sm font-medium text-gray-600 mb-1">
                            Link Metni ({langNames[lang as keyof typeof langNames]})
                          </label>
                          <input
                            type="text"
                            name={`${lang}_linkText`}
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-hotel-gold focus:border-transparent"
                            placeholder={`${langNames[lang as keyof typeof langNames]} link metni`}
                          />
                        </div>
                      </div>
                    </div>
